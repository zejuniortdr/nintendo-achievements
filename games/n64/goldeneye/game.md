...
- [x] Completar Dam (Agent)
- [x] Completar Facility (Agent)
- [x] Completar Runway (Agent)
- [x] Completar Surface 1 (Agent)
- [x] Completar Bunker 1 (Agent)
- [x] Completar Silo (Agent)
- [x] Completar Frigate (Agent)
- [x] Completar Surface 2 (Agent)
- [x] Completar Bunker 2 (Agent)
- [x] Completar Statue Park (Agent)
- [x] Completar Archives (Agent)
- [x] Completar Streets (Agent)
- [x] Completar Depot (Agent)
- [x] Completar Train (Agent)
- [x] Completar Jungle (Agent)
- [x] Completar Control (Agent)
- [x] Completar Caverns (Agent)
- [x] Completar Cradle (Agent)
- [x] Completar Aztec (Agent)
- [x] Completar Egyptian - Bônus (Agent)
